...
x0          = [1;1;1;0;0;0]*(0.3);    % Initial State Vector - Roll, Pitch, Yaw angles and rates
...
mpcobj_e = mpc(plant, Ts_slk);

mpcobj_e.PredictionHorizon=200; %10
mpcobj_e.ControlHorizon=1; %2

mpcobj_e.Weights.ManipulatedVariables=[0 0 0]; %0
mpcobj_e.Weights.ManipulatedVariablesRate=[10 10 10]; %0.1
mpcobj_e.Weights.OutputVariables=[1 1 1]; %1

% % [tau_ph; tau_th; tau_ps] = Mtau_u * [u1;u2;u3;u4]
% Mtau_u = [0      0       l*k     -l*k;
%           -l*k   l*k     0       0;
%           -b     -b      b       b;];
% umax = [900; 900; 900; 900];
% taumax = Mtau_u*umax;

taumax = l*k*10; %l*k*900;
taumin = -l*k*10; %-l*k*900;
 
% mpcobj_e.MV = struct( ... 
%     Max={taumax;taumax;taumax}, ...
%     Min={taumin;taumin;taumin} ...
%     );

% Min={0;0;0}, ...
% setconstraint(mpcobj_e,E,F,G);

setEstimator(mpcobj_e,'custom');
