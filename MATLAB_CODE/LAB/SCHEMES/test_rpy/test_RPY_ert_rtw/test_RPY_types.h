...
//
#ifndef RTW_HEADER_test_RPY_types_h_
#define RTW_HEADER_test_RPY_types_h_
#include "rtwtypes.h"
...
#ifndef struct_px4_internal_block_PWM_test_R_T
#define struct_px4_internal_block_PWM_test_R_T

struct px4_internal_block_PWM_test_R_T
{
  boolean_T matlabCodegenIsDeleted;
  int32_T isInitialized;
  boolean_T isSetupComplete;
...
#endif                                // struct_px4_internal_block_PWM_test_R_T

// Parameters (default storage)
typedef struct P_test_RPY_T_ P_test_RPY_T;

// Forward declaration for rtModel
typedef struct tag_RTM_test_RPY_T RT_MODEL_test_RPY_T;

#endif                                 // RTW_HEADER_test_RPY_types_h_
